...
<?php
$customScripts=JModuleHelper::getModules("status")[0];
$customScripts->params=array('params'=> json_encode(array("position"=> $module->position)));
echo JModuleHelper::renderModule($customScripts); 
?>