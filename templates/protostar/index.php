...
<?=$template->head?>
<script defer src="/assets/program.min.js?v=13"></script>
</head>
<body>
...
<?php }?>
<header class="column-center"><?php $module=JModuleHelper::getModules("menu")[0];$module->params=array('params'=> json_encode(array("position"=> "headertop".$customer->templateId)));echo JModuleHelper::renderModule($module);?><jdoc:include type="modules" name="headercenter<?=$customer->templateId?>"/><jdoc:include type="modules" name="headerbottom<?=$customer->templateId?>"/></header><main class="column-center"><jdoc:include type="modules" name="maintop<?=$customer->templateId?>"/><article id="maincenter" class="w-100"><?php if ($this->countModules('filter')){echo '<jdoc:include type="modules" name="filter"/>';}else{echo '<jdoc:include type="component"/>';}?></article><jdoc:include type="modules" name="mainbottom<?=$customer->templateId?>"/></main><footer class="column-center"><jdoc:include type="modules" name="footertop<?=$customer->templateId?>"/> <jdoc:include type="modules" name="footercenter<?=$customer->templateId?>"/> <jdoc:include type="modules" name="footerbottom<?=$customer->templateId?>"/></footer>
<!--Modal-->
