...
a.slide:before {
	...
	width: 0;
	background: none;
	transition: width .5s ease, background-color .5 ease;
}
a.slide:after {
	right: 0;
	bottom: -3px;
...
header img,
main > *:not(div[itemprop="articleBody"]) img,
footer img {
    max-width: 100%;
    width: 100%;
    height: auto;
...
<header class="column-center">
   <jdoc:include type="modules" name="headertop<?=$customer->templateId?>" />
	<jdoc:include type="modules" name="headercenter<?=$customer->templateId?>" />
	<jdoc:include type="modules" name="headerbottom<?=$customer->templateId?>" />
</header>
<main class="column-center">
    <jdoc:include type="modules" name="maintop<?=$customer->templateId?>" />
    ...
    <jdoc:include type="modules" name="mainbottom<?=$customer->templateId?>" />
</main>
<footer class="column-center">
    <jdoc:include type="modules" name="footertop<?=$customer->templateId?>" />
    <jdoc:include type="modules" name="footercenter<?=$customer->templateId?>" />
    <jdoc:include type="modules" name="footerbottom<?=$customer->templateId?>" />
</footer>
<!--Modal-->
