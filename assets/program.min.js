...
program.onload = function() {
	...
	if(window.innerWidth >=745) {
		 for(var x=0; x<whatsapp.length; x++){
			 whatsapp[x].href='https://api.whatsapp.com/send?phone='+customer.celParsed+'&text=Hola%20'+customer.customernameParsed+'%20quisiera%20realizar%20una%20consulta%20';
			 whatsapp[x].target="_blank";
		 }
		 for(var x=0; x<whatsapp2.length; x++){
			 whatsapp2[x].href='https://api.whatsapp.com/send?phone='+customer.cel2Parsed+'&text=Hola%20'+customer.customernameParsed+'%20quisiera%20realizar%20una%20consulta%20';
			 whatsapp2[x].target="_blank";
		 }
	 }
	 else {
		 for(var x=0; x<whatsapp.length; x++){
			whatsapp[x].href='https://wa.me/+'+customer.celParsed+'?text=Hola%20'+customer.customernameParsed+'%20quisiera%20realizar%20una%20consulta%20';
		 }
		 for(var x=0; x<whatsapp2.length; x++){
			whatsapp2[x].href='https://wa.me/+'+customer.cel2Parsed+'?text=Hola%20'+customer.customernameParsed+'%20quisiera%20realizar%20una%20consulta%20';
		 }
	}
	/*mailto*/
	var mailto = document.querySelectorAll(".mailto");
	for(var x=0; x<mailto.length; x++){
		mailto[x].href = 'mailto:'+customer.email+'?subject=Consulta%20desde%20pagina%20web%20'+customer.customernameParsed+'&body=Hola%20'+customer.customernameParsed+'%20quisiera%20realizar%20la%20siguiente%20consulta';
