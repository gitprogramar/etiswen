...
/*Notify*/
program.notify=function(pTitle, pMsg, pType, pTime){var notify=document.getElementById("notify"); if (notify.classList.contains("modal-hidden")){notify.classList.toggle("modal-hidden");}if (notify.classList.contains("notify-show")){notify.classList.toggle("notify-show"); notify.classList.toggle("notify-discard");}if (notify.classList.contains("notify-success")){notify.classList.toggle("notify-success");}if (notify.classList.contains("notify-fail")){notify.classList.toggle("notify-fail");}if (notify.classList.contains("notify-warning")){notify.classList.toggle("notify-warning");}notify.classList.toggle("notify-" + pType); document.getElementById("notify-title").innerHTML=pTitle; document.getElementById("notify-message").innerHTML=pMsg; notify.classList.toggle("notify-show"); notify.style.top=(window.pageYOffset + 30) + "px"; if (pTime==undefined){pTime=4000;}window.setTimeout(function(){var notify=document.getElementById("notify"); if (notify.classList.contains("notify-discard")){notify.classList.toggle("notify-discard");}else{notify.classList.toggle("notify-show"); notify.classList.toggle("modal-hidden");}}, pTime);};
/*Theme selector*/
...
program.onload = function() {
	...
	if(year != undefined) {
		...
		/*session*/
		document.getElementById("clearsession").addEventListener('click', function(e) { 
			e.preventDefault();
	...
	var whatsapp2 = document.querySelectorAll(".whatsapp2");
	var message = encodeURI(customer.customername + ' ' + customer.message);
	var subject = encodeURI(customer.subject + ' - ' + customer.customername);
	if(window.innerWidth >=745) {
		 for(var x=0; x<whatsapp.length; x++){
			 whatsapp[x].href='https://api.whatsapp.com/send?phone='+customer.celParsed+'&text='+(whatsapp[x].getAttribute('data-value') == undefined ? message : encodeURI(whatsapp[x].getAttribute('data-value')));
			 whatsapp[x].target="_blank";
		 }
		 for(var x=0; x<whatsapp2.length; x++){
			 whatsapp2[x].href='https://api.whatsapp.com/send?phone='+customer.cel2Parsed+'&text='+(whatsapp2[x].getAttribute('data-value') == undefined ? message : encodeURI(whatsapp2[x].getAttribute('data-value')));
			 whatsapp2[x].target="_blank";
		 }
	 }
	 else {
		 for(var x=0; x<whatsapp.length; x++){
			whatsapp[x].href='https://wa.me/+'+customer.celParsed+'?text='+(whatsapp[x].getAttribute('data-value') == undefined ? message : encodeURI(whatsapp[x].getAttribute('data-value')));
		 }
		 for(var x=0; x<whatsapp2.length; x++){
			whatsapp2[x].href='https://wa.me/+'+customer.cel2Parsed+'?text='+(whatsapp2[x].getAttribute('data-value') == undefined ? message : encodeURI(whatsapp2[x].getAttribute('data-value')));
		 }
	}
	/*mailto*/
	var mailto = document.querySelectorAll(".mailto");
	for(var x=0; x<mailto.length; x++){
		mailto[x].href = 'mailto:'+customer.email+'?subject='+subject+'&body='+(mailto[x].getAttribute('data-value') == undefined ? message : encodeURI(mailto[x].getAttribute('data-value')));
		mailto[x].innerHTML += customer.email;
	}
    /*Fix index.php links*/
    var links = document.querySelectorAll('a[href*="index.php"]');
    for (var x = 0; x < links.length; x++) {
        links[x].href = links[x].href.replace("index.php", "");
    }
};
