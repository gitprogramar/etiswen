...
/*Cookies*/
program.Cookies = {};
program.Cookies.get = function(name) {
    var v = document.cookie.match('(^|;) ?' + name + '=([^;]*)(;|$)');
    return v ? v[2] : null;
}
program.Cookies.set = function(name, value, days) {
    var d = new Date;
	if(days==undefined)
		days = 30;
...
program.Cookies.delete = function(name) { program.Cookies.set(name, '', -1); }
/*Theme selector*/
