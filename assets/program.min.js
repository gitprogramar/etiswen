...
program.onload = function() {
	...
	/*whatsapp*/
	var whatsapp=document.querySelectorAll(".whatsapp");var whatsapp2=document.querySelectorAll(".whatsapp2");var message=encodeURI(customer.customername + ' ' + customer.message);var subject=encodeURI(customer.subject + ' - ' + customer.customername);if(window.innerWidth >=745){for(var x=0; x<whatsapp.length; x++){whatsapp[x].href='//api.whatsapp.com/send?phone='+customer.celParsed+'&text='+(whatsapp[x].getAttribute('data-value')==undefined ? message : encodeURI(whatsapp[x].getAttribute('data-value'))); whatsapp[x].target="_blank";}for(var x=0; x<whatsapp2.length; x++){whatsapp2[x].href='//api.whatsapp.com/send?phone='+customer.cel2Parsed+'&text='+(whatsapp2[x].getAttribute('data-value')==undefined ? message : encodeURI(whatsapp2[x].getAttribute('data-value'))); whatsapp2[x].target="_blank";}}else{for(var x=0; x<whatsapp.length; x++){whatsapp[x].href='//wa.me/+'+customer.celParsed+'?text='+(whatsapp[x].getAttribute('data-value')==undefined ? message : encodeURI(whatsapp[x].getAttribute('data-value')));}for(var x=0; x<whatsapp2.length; x++){whatsapp2[x].href='//wa.me/+'+customer.cel2Parsed+'?text='+(whatsapp2[x].getAttribute('data-value')==undefined ? message : encodeURI(whatsapp2[x].getAttribute('data-value')));}}
	/*mailto*/
	var mailto=document.querySelectorAll(".mailto");for(var x=0; x<mailto.length; x++){mailto[x].href='mailto:'+customer.email+'?subject='+subject+'&body='+(mailto[x].getAttribute('data-value')==undefined ? message : encodeURI(mailto[x].getAttribute('data-value')));mailto[x].innerHTML +=customer.email;}
    /*Fix index.php links*/
