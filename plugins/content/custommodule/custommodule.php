 ...
 * @subpackage  Content.custommodule
 *
 ...
 * This uses the {custommodule} syntax
 *
 * @since  1.5
 */
class PlgContentCustommodule extends JPlugin
{
	...
	public function onContentPrepare($context, &$article, &$params, $page = 0)
	{
		...
		if (strpos($article->text, '{module') === false && strpos($article->text, 'custommodule') === false)
		{
			return true;
		}
		...
		// Find all instances of plugin and put in $matchesmod for custommodule
	...
	protected function _load($position, $style = 'none')
	{
		...
		{
			$param = array('custom_param' => $style);  // param_name = value
